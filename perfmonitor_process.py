...
class perfmonitor_process(object):
...
|                              Usage Instructions                                    |
======================================================================================""")
        print("""|  usage              : python perfmonitor_process.py PIDList MonitorTime""")
        print("""|  example            : python perfmonitor_process.py 1846,3252 1""")
        print("""======================================================================================""")
        sys.exit()
    pid_list = sys.argv[1].split(",")
    #pid_list = list(psutil.process_iter())
    #print pid_list
    monitor_time = int(sys.argv[2])
    perfm = perfmonitor_process(pid_list, monitor_time)
    perfm.perfrunner()
